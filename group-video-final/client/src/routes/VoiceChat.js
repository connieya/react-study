...
const VoiceChat = () => {
  ...
  let UserMedia;
  if (stream) {
    UserMedia = <Video playsInline muted ref={userMedia} autoPlay />;
  }
  let PartnerMedia;
  if (callAccepted) {
    PartnerMedia = <Video playsInline ref={partnerMedia} autoPlay />;
  }
    ...
    <Container>
      ...
      <Row className='center'>
        {Object.keys(users).map((key) => {
          ...
          return (
            <Button variant='info' onClick={() => callPeer(key)}>
              Call {key}
            </Button>
          );
        })}
      </Row>
      <Row className='center'>{incomingCall}</Row>
      ...
      <span className='center'>
        ...
        <Button variant='danger' id='stopButton'>
          Stop Recording
        </Button>
      </span>
      <br />
